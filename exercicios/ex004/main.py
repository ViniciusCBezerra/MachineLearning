...
dados = pd.read_csv('exercicios/ex004/arquivos_usados/marketing_investimento.csv')
...
dados_para_algoritmo = pd.DataFrame(variaveis_explicativas,columns=colunas_transformadas)
